...
CREATE TABLE `tblhost` (
  ...
  `Floor No` int(1) NOT NULL,
  `Room No` int(3) NOT NULL,
  `Mobile Number` bigint(10) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `tblhost`
--

INSERT INTO `tblhost` ( `Name`, `Floor No`, `Room No`, `Mobile Number` ) VALUES
('AAKASH', 1,101,1234567890),
('ARUNAPRAKASH', 1,102,0987654321),
('ABISHEK', 2,201,9874563210),
('DHARUN', 2,202,6541230987);
